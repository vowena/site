...
Read the [full API reference](/docs) for every contract function. The [source code](https://github.com/vowena/protocol) is open and has 29 passing tests covering every edge case described in this post.
