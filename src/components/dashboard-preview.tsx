      ...
      <div className="flex">
        ...
        <div className="w-12 bg-surface border-r border-border py-3 flex flex-col items-center gap-3 shrink-0">
          <div className="w-6 h-6 rounded-lg bg-accent flex items-center justify-center">
            <svg className="w-3 h-3 text-white" viewBox="0 0 80 80" fill="none">
              <path
        ...
        <div className="flex-1 p-4 space-y-3 min-w-0">
          ...
          <div className="flex items-center justify-between">
            ...
            <div className="w-6 h-6 rounded-full bg-accent-subtle flex items-center justify-center text-[8px] text-accent font-bold">
              T
            </div>
          </div>
          ...
          <div className="rounded-lg border border-border bg-background p-3">
            <div className="flex items-center justify-between mb-2">
              ...
              <div className="flex gap-1">
                <span className="text-[7px] text-muted px-1 py-0.5 rounded bg-surface border border-border">
                  7d
                </span>
                <span className="text-[7px] text-white px-1 py-0.5 rounded bg-accent">
                  30d
                </span>
              </div>
            </div>
            ...
            >
              ...
              <path
                d="M0 42 L25 38 L50 36 L75 32 L100 28 L125 25 L150 22 L175 20 L200 16 L225 14 L250 10 L275 8 L300 4 L300 50 L0 50Z"
                fill="url(#hcf)"
              />
              <path
                d="M0 42 L25 38 L50 36 L75 32 L100 28 L125 25 L150 22 L175 20 L200 16 L225 14 L250 10 L275 8 L300 4"
                fill="none"
                stroke="var(--accent)"
                strokeWidth="1.5"
              />
          ...
          <div className="rounded-lg border border-border bg-background overflow-hidden">
            ...
            {[
              ...
              <div
                key={row.addr}
                className="flex items-center justify-between px-2.5 py-1.5 border-b border-border last:border-0"
              >
                <div className="flex items-center gap-1.5">
                  <div className="w-4 h-4 rounded-full bg-accent-subtle flex items-center justify-center text-[6px] text-accent font-bold">
                    {row.addr[0]}
                  </div>
                  <div>
                    <p className="text-[8px] font-mono text-foreground">
                      {row.addr}
                    </p>
                    <p className="text-[6px] text-muted">{row.action}</p>
                  </div>
                </div>
                <span className={`text-[8px] font-medium ${row.color}`}>
                  {row.amount}
                </span>
              </div>
            ))}
    ...
    <div className="space-y-4">
      <div className="rounded-xl border border-border bg-elevated p-5">
        ...
        <div className="rounded-lg border border-border bg-background p-4">
          <div className="flex items-center justify-between mb-3">
            ...
            <span className="text-[9px] font-medium text-success bg-success-subtle px-2 py-0.5 rounded-full">
              Active
            </span>
          </div>
          <div className="flex items-center justify-between pt-3 border-t border-border">
            ...
            <div className="text-right">
              ...
              <p className="text-xs font-semibold text-foreground">
                $29.99 <span className="text-muted font-normal">USDC</span>
              </p>
            </div>
          </div>
        </div>
        ...
        <div className="space-y-2">
          {[
            ...
            >
              ...
              <span
                className={`text-[9px] font-medium ${row.status === "Trial" ? "text-warning" : "text-success"}`}
              >
                {row.status}
              </span>
            </div>
      ...
      <div className="rounded-xl border border-border bg-elevated p-5">
        ...
        <p className="text-xs text-secondary leading-relaxed mb-3">
          Subscribers can view history, manage their subscription, or cancel
          anytime. No emails, no phone calls. Direct on-chain.
        </p>
        <div className="flex gap-2">
          <div className="flex-1 text-center py-2 rounded-lg border border-border text-[10px] text-secondary font-medium">
            View history
          </div>
          <div className="flex-1 text-center py-2 rounded-lg border border-error/20 text-[10px] text-error font-medium">
            Cancel
          </div>
        </div>
      </div>
