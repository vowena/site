    ...
    >
      ...
      >
        <div style={{ display: "flex", alignItems: "center", gap: "10px" }}>
          ...
          <span style={{ fontSize: 12, color: "#9B95B8", marginLeft: 4 }}>
            Blog
          </span>
        </div>
        ...
        <div style={{ display: "flex", alignItems: "center", gap: "12px" }}>
          ...
          <div style={{ display: "flex", flexDirection: "column" }}>
            <span style={{ fontSize: 14, fontWeight: 500, color: "#0E0D18" }}>
              {author}
            </span>
          ...
          <div style={{ position: "absolute", inset: 0, display: "flex" }}>
            ...
            <div
              style={{
                ...
                bottom: 0,
                width: 80,
                background: "linear-gradient(to right, #FEFCFF, transparent)",
                zIndex: 1,
              }}
            />
            <img
