    ...
    <>
      ...
      <section className="relative overflow-hidden">
        ...
        <div className="max-w-6xl mx-auto px-4 sm:px-6 pt-24 sm:pt-36 pb-16 sm:pb-24">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-16 items-center">
            <div>
              <SectionEyebrow className="mb-7">
                Recurring payments on Stellar
              </SectionEyebrow>

              <h1
                className="text-4xl sm:text-5xl lg:text-[3.75rem] font-semibold text-foreground leading-[1.04] tracking-tight"
              ...
              <p className="mt-7 text-base sm:text-lg text-secondary leading-relaxed max-w-xl">
                Add recurring USDC payments to your product. Customers subscribe
                once, billing runs on autopilot. No chargebacks, no payment
                processors, no hidden fees.
              </p>
            ...
            <div className="relative hidden lg:block -mt-28 sm:-mt-36 -mb-32 sm:-mb-40">
              <div
                style={{
                  maskImage:
                    "linear-gradient(to right, black 0%, black 80%, transparent 98%), linear-gradient(to bottom, black 0%, black 80%, transparent 98%)",
        ...
        <div className="border-t border-border bg-surface/50">
          <Link href={siteConfig.vowenaTipUrl} className="group block">
      ...
      <section className="relative border-t border-border">
        ...
        <div className="max-w-6xl mx-auto px-4 sm:px-6 py-16 sm:py-24">
          ...
          <h2
            className="text-3xl sm:text-4xl lg:text-[2.75rem] font-semibold text-foreground tracking-tight mb-5 leading-[1.1]"
            style={{ letterSpacing: "-0.025em" }}
          >
            Launch subscriptions in{" "}
          ...
          <p className="text-secondary max-w-lg mb-12 sm:mb-16">
            No payment processor applications. No KYC delays. Connect your
            wallet, create a plan, and start billing.
          </p>
                ...
                visual: (
                  <div className="rounded-lg border border-border bg-surface p-4 space-y-2">
                    ...
                    <div className="mt-2 pt-2 border-t border-border">
                      <div className="w-full h-7 bg-accent rounded-md flex items-center justify-center text-[10px] text-white font-medium">
                        Create plan
                      </div>
                    </div>
                  </div>
                ...
                visual: (
                  <div className="rounded-lg border border-border bg-surface p-4 space-y-3">
                    ...
                    <div className="flex gap-2">
                      <div className="flex-1 text-center py-1.5 rounded-md border border-border text-[9px] text-secondary">
                        Embed button
                      </div>
                      <div className="flex-1 text-center py-1.5 rounded-md bg-accent text-[9px] text-white">
                        Copy link
                      </div>
                    </div>
                  </div>
                ...
                visual: (
                  <div className="rounded-lg border border-border bg-surface p-4">
                    ...
                    >
                      ...
                      <path
                        d="M0 35 L20 30 L40 28 L60 25 L80 22 L100 20 L120 18 L140 15 L160 12 L180 10 L200 5 L200 40 L0 40Z"
                        fill="url(#miniChart)"
                      />
                      <path
                        d="M0 35 L20 30 L40 28 L60 25 L80 22 L100 20 L120 18 L140 15 L160 12 L180 10 L200 5"
                        fill="none"
                        stroke="var(--success)"
                        strokeWidth="1.5"
                      />
      ...
      <section className="relative border-t border-border bg-surface">
        ...
        <div className="max-w-6xl mx-auto px-4 sm:px-6 py-16 sm:py-24">
          ...
          <h2
            className="text-3xl sm:text-4xl lg:text-[2.75rem] font-semibold text-foreground tracking-tight mb-12 sm:mb-16 leading-[1.1]"
            style={{ letterSpacing: "-0.025em" }}
          >
            Billing infrastructure that{" "}
            <span className="serif-italic text-accent text-[1.1em]">works</span>{" "}
            for you.
          </h2>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4">
            ...
            <div className="lg:col-span-2 rounded-xl border border-border bg-elevated p-8 flex flex-col">
              ...
              <p className="text-sm text-muted leading-relaxed max-w-md mb-6 flex-1">
                Subscribers authorize a spending limit upfront. The contract can
                never charge more than they approved. No surprise fees, no card
                disputes, no revenue clawbacks.
              </p>
              <div className="flex flex-wrap items-center gap-3 text-xs text-muted font-mono">
                <span className="px-2 py-1 rounded bg-surface border border-border">
                  Subscriber approves: $39.99 max
                </span>
                <span className="text-accent">&#8594;</span>
                <span className="px-2 py-1 rounded bg-accent-subtle border border-accent/20 text-accent">
                  You charge: $29.99
                </span>
                <span className="px-2 py-1 rounded bg-surface border border-border text-foreground">
                  Disputes: 0
                </span>
              </div>
            </div>
            <div className="rounded-xl border border-border bg-elevated p-6 flex flex-col">
              ...
              <p className="text-sm text-muted leading-relaxed mb-4 flex-1">
                Each charge costs $0.00001. Not 2.9% + 30 cents. On $29.99,
                Stripe takes $1.17. Vowena takes a fraction of a cent.
              </p>
            ...
            <div className="rounded-xl border border-border bg-elevated p-6">
              ...
              <p className="text-sm text-muted leading-relaxed">
                Customers see exactly what they approve in their wallet. Price
                changes require their consent. Trust means lower churn.
              </p>
            </div>
            <div className="rounded-xl border border-border bg-elevated p-6">
              <h3 className="text-sm font-semibold text-foreground mb-2">
              ...
              <p className="text-sm text-muted leading-relaxed">
                Enable auto-billing and charges run on schedule. Failed payments
                get automatic retries during a grace window.
              </p>
            </div>
            <div className="rounded-xl border border-border bg-elevated p-6">
              <h3 className="text-sm font-semibold text-foreground mb-2">
              ...
              <p className="text-sm text-muted leading-relaxed">
                USDC works in 180+ countries. No international card fees, no FX
                conversion. Same experience everywhere.
              </p>
            </div>
          </div>
        </div>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-16 items-start">
            <div>
              ...
              <p className="text-secondary leading-relaxed mb-8">
                Create plans, track revenue, manage subscribers, issue refunds,
                and automate billing. All in one place.
              </p>
                ...
                {[
                  {
                    ...
                    desc: "MRR, churn rate, failed payments, subscriber growth. Real-time charts and exportable data.",
                  },
                  {
                    title: "Subscriber management",
                    desc: "See every subscriber, their billing history, status, and next charge date. One-click refunds.",
                  },
                  {
                    title: "Plan management",
                    desc: "Create unlimited plans with different pricing, trials, and grace periods. Migrate subscribers between plans.",
                  },
                  {
                    title: "Automated keeper",
                    desc: "Toggle auto-billing and charges run on schedule. Handles retries and grace periods automatically.",
                  },
                ].map((item) => (
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-16 items-start">
            <div>
              ...
              <p className="text-secondary leading-relaxed mb-6">
                The dashboard is optional. Install the SDK and integrate
                subscription billing directly into your product. Full TypeScript
                support, event polling, and a standalone keeper bot.
              </p>
              ...
              <div className="flex flex-wrap gap-3 text-xs text-muted">
                <Link
                  href="/docs"
                  className="inline-flex items-center gap-2 px-4 py-2 rounded-lg border border-border hover:border-accent/30 hover:text-accent transition-colors"
                >
                  <svg
                    className="w-4 h-4"
                    viewBox="0 0 24 24"
