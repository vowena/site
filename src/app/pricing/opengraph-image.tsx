          ...
          {[
            ...
            <div
              ...
              style={{
                ...
                padding: "20px",
                borderRadius: 12,
                border: tier.badge ? "2px solid #6B4EFF" : "1px solid #E8E5F0",
                background: tier.badge ? "rgba(107, 78, 255, 0.03)" : "#F6F4FA",
                display: "flex",
                flexDirection: "column",
                gap: "4px",
              }}
            >
              ...
              {tier.badge && (
                <span style={{ fontSize: 10, fontWeight: 600, textTransform: "uppercase" as const, letterSpacing: "0.1em", color: "#00DC82", background: "#DBFFF0", padding: "2px 8px", borderRadius: 100, alignSelf: "flex-start" }}>
                  Free during beta
                </span>
              )}
            </div>
